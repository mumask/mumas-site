...
// =======================
// Background Animation (Canvas Fluid + Particles)
// =======================
...
// =======================
const audio = new Audio('https://archive.org/download/MiceOnVenus/MiceOnVenus.mp3'); // link mp3 direto
audio.loop = true;
audio.volume = 0.3;
audio.play().catch(e => console.log("Música não pode ser reproduzida automaticamente:", e));
